      ...
      <div className="px-3 py-3 border-b border-slate-100 dark:border-slate-700/60 flex items-center gap-2">
        ...
        {onCollapse && (
          <button
            ...
            className="hidden md:flex w-7 h-7 items-center justify-center rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors flex-shrink-0 cursor-pointer"
          >
