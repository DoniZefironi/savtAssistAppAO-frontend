      ...
      {!sidebarOpen && (
        <div className="hidden md:flex flex-col items-center flex-shrink-0 w-10 h-full bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700/60">
          <button
            ...
            className="mt-3 w-7 h-7 flex items-center justify-center rounded-lg text-slate-400 hover:text-[#1B3A72] dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
          >
