...
import { FileText, FileSpreadsheet, Video, Archive, Paperclip } from 'lucide-react'

export function EmptyAttach({ label }: { label: string }) {
  return (
...
export function DownloadSmIcon() {
...
export function HeaderMenuItem({ icon, onClick, danger, children }: { icon: React.ReactNode; onClick: () => void; danger?: boolean; children: React.ReactNode }) {
  return (
