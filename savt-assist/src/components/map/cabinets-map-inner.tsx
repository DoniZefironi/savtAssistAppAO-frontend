    ...
    <>
      ...
      <div className="relative isolate w-full h-full">
        ...
        <MapContainer
          center={[53.9, 27.5]}
          zoom={7}
          // Без ограничений карту можно утащить за полюса (там тайлов физически
          // нет — пустота) или по долготе в соседнюю "копию мира" (тайлы честно
          // повторяются по кругу, а маркеры ШУ — нет, они привязаны к одной
          // точке). Границы — реальный предел проекции Меркатора по широте
          // (±85°, дальше её просто не существует) и один оборот по долготе.
          // Viscosity=1 — жёсткий предел, а не пружинка: сразу не пускает
          // утащить дальше, а не откатывает уже после того, как утащили.
